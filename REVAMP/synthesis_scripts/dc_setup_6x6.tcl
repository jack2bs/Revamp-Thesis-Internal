...
source -echo -verbose ./define_setup.tcl
...
set RTL_SOURCE_FILES  "$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/common/globals_top.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/common/globals_network_6x6.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/cgra_6x6.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/tile.sv \
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/regFile.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/xbar_bypass.sv \
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/xbar_bypass_msb.sv \
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/xbar_bypass_lsb.sv \
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/configuration.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/common/encoder_onehot.sv \
        $DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/router.sv \
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/load_store.sv\
	$DESIGN_REF_DATA_PATH/HOMOGENEOUS_ARCHITECTURE/RTL/simple_alu_wrapper.sv "      ;# Enter the list of source RTL files if reading from RTL
