...
def main():
    ...
    os.system('cp -r '+REVAMP_APPLICATIONS+'/applications_6x6 '+ REVAMP_ARCHI_GEN_HOME+'/applications')
    print('src/build/generator -d applications -a '+REVAMP_HOMOGENEOUS_ARCHITECTURE + '/hycube_original_6x6_torus.json -c config_6x6.json')
    outlog.write('src/build/generator -d applications -a '+REVAMP_HOMOGENEOUS_ARCHITECTURE + '/hycube_original_6x6_torus.json -c config_6x6.json\n')
    os.system('src/build/generator -d applications -a '+REVAMP_HOMOGENEOUS_ARCHITECTURE + '/hycube_original_6x6_torus.json -c config_6x6.json >> /dev/null')
