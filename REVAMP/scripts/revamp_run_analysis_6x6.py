...
def main():
    ...
    compare_with_homo(throughput['hycube_original_6x6_torus'],throughput,power['hycube_original_6x6_torus'],power,area['hycube_original_6x6_torus'],area)
    ...
    print('Throughput impact:'+str((float(sorted_throughput['hycube_original_6x6_torus'])-float(sorted_throughput[max_pow]))*100/float(sorted_throughput['hycube_original_6x6_torus']))+'%\n')
    outlog.write(str(max_pow)+'\n')
    outlog.write('Throughput impact:'+str((float(sorted_throughput['hycube_original_6x6_torus'])-float(sorted_throughput[max_pow]))*100/float(sorted_throughput['hycube_original_6x6_torus']))+'%\n')
    ...
    print('Throughput impact:'+str((float(sorted_throughput['hycube_original_6x6_torus'])-float(sorted_throughput[max_area]))*100/float(sorted_throughput['hycube_original_6x6_torus']))+'%\n')
    outlog.write('Throughput impact:'+str((float(sorted_throughput['hycube_original_6x6_torus'])-float(sorted_throughput[max_area]))*100/float(sorted_throughput['hycube_original_6x6_torus']))+'%\n')
